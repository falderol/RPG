...
Parts of this code are very poorly written. Some of it is for efficiency, some of it is autogenerated, some of it has no excuse. Fixing it is the next thing on my list of what to do with this library when i have time.
